...
//renombrar una llave sin modificar el valor
/* db.users.updateMany(
    {},
...
//1.Traer todos los mayores de 18
db.users.find({ age : {$gt: 18}});
//========================================================================================================================
//2.Obtener todos los usuarios de londres
db.users.find({city : {$eq: "Londres"}});
//========================================================================================================================
//3. Traer los que ganen + 2000 y - 30 años
db.users.find({
    $and: [
        {salary:{$gt: 2000}},
        {age: {$lt: 30}}
